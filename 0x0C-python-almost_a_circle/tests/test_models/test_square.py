...
Unittest classes:
    _instantiation - line 24
    _size - line 88
    _x - line 166
    _y - line 238
    _order_of_initialization - line 306
    _area - line 322
    _stdout - line 343
    _update_args - line 426
    _update_kwargs - line 538
    _to_dictionary - 640
"""
import io
import sys
...
class _instantiation(unittest.TestCase):
    """Unittests - Init Square class"""
...
class _size(unittest.TestCase):
    """Unittests - size init of Square class"""
...
class _y(unittest.TestCase):
    """Unittests - Init of Y attribute"""
...
class _order_of_initialization(unittest.TestCase):
    """Unittests - order of Square Init"""
...
class _area(unittest.TestCase):
    """Unittests - the area of Square class"""
...
class _stdout(unittest.TestCase):
    """Unittests - __str__ and display"""
    ...
    def test_str_method_print_size(self):
        s = Square(4)
        capture = _stdout.capture_stdout(s, "print")
    ...
    def test_display_size(self):
        s = Square(2, 0, 0, 9)
        capture = _stdout.capture_stdout(s, "display")
        self.assertEqual("##\n##\n", capture.getvalue())
...
class _update_args(unittest.TestCase):
    """Unittests - update args"""
...
class _update_kwargs(unittest.TestCase):
    """Unittests - update kwargs"""
...
class _to_dictionary(unittest.TestCase):
    """Unittests - to_dictionary"""
